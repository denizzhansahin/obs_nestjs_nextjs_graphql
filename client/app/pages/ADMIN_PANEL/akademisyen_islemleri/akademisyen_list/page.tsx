...
interface Instructor {
  ...
  created_at: string;
  updated_at: string;
  courseInstructors: Array<{ course: { name: string; code: string; credit?: string } }>;
  enrollments: Array<{ course: { name: string; code: string; credit?: string } }>;
}
...
const rows = React.useMemo(() => {
  return (data?.getInstructors || []).map((instructor: Instructor) => ({
